...
\todo[inline]{below is a re-written paragraph }
...
\todo[inline]{This page is in colour!}
...
where a network with more than a million nodes takes 4 minutes to pre-process while the 
