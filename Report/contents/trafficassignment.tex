...
These assumptions may not be realistic \todo{keep?} but they allow us to formulate the traffic assignment model as a mathematical probram.
    ...
    \begin{tikzpicture}
        \begin{axis}
            [
                ...
                extra y ticks={20},
                extra y tick labels={Freeflow time $(s_f)$},
