...
\todo[inline]{excluded ` symmetric', it is too confusing}
%In this section,
...
\todo[inline]{this section is inspired by Olga's article ``A Computational Study of Traffic Assignment Algorithms''}
...
The rate of convergence does not decrease monotonically. \todo{\ldots how do I describe the convergence behaviour? }
