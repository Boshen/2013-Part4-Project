...
\todo[inline]{maybe need profile output support to support this statement?}
...
\begin{table}[H]
    ...
    \label{table:heaps}
\end{table}
\todo[inline]{explain breifly what these Heaps are}
...
\todo[inline]{how about storing data? e.g.\ shortest path trees?}
