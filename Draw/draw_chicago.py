...
#plt.xlim(0,xmax)
#plt.ylim(0,ymax)
#plt.legend([p1, p2, p3],["unscanned arcs or\n arcs connecting zones", "scanned arcs", "shortest path"], bbox_to_anchor=(0, 0, 0.95, 0.9), loc=1, prop={"size":26}, frameon=False) 
...
plt.axis("off")
#plt.savefig("chicago_astar.pdf", bbox_inches="tight")    
